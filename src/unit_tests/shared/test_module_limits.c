...
static void test_fim_limits_init_success(void **state) {
    ...
    assert_int_equal(fim.registry, DEFAULT_FIM_REGISTRY_LIMIT);
}
...
static void test_syscollector_limits_init_success(void **state) {
    ...
    assert_int_equal(syscollector.hotfixes, DEFAULT_SYSCOLLECTOR_HOTFIXES);
    assert_int_equal(syscollector.packages, DEFAULT_SYSCOLLECTOR_PACKAGES);
    assert_int_equal(syscollector.processes, DEFAULT_SYSCOLLECTOR_PROCESSES);
    assert_int_equal(syscollector.ports, DEFAULT_SYSCOLLECTOR_PORTS);
    assert_int_equal(syscollector.network_iface, DEFAULT_SYSCOLLECTOR_NETWORK_IFACE);
    assert_int_equal(syscollector.network_protocol, DEFAULT_SYSCOLLECTOR_NETWORK_PROTO);
    assert_int_equal(syscollector.network_address, DEFAULT_SYSCOLLECTOR_NETWORK_ADDR);
    assert_int_equal(syscollector.hardware, DEFAULT_SYSCOLLECTOR_HARDWARE);
    assert_int_equal(syscollector.os_info, DEFAULT_SYSCOLLECTOR_OS_INFO);
    assert_int_equal(syscollector.users, DEFAULT_SYSCOLLECTOR_USERS);
    assert_int_equal(syscollector.groups, DEFAULT_SYSCOLLECTOR_GROUPS);
    assert_int_equal(syscollector.services, DEFAULT_SYSCOLLECTOR_SERVICES);
}
...
static void test_sca_limits_init_success(void **state) {
    ...
    assert_int_equal(sca.checks, DEFAULT_SCA_CHECKS);
}
...
static void test_module_limits_init_success(void **state) {
    ...
    assert_int_equal(limits.fim.registry, DEFAULT_FIM_REGISTRY_LIMIT);

    /* Verify Syscollector limits */
    assert_int_equal(limits.syscollector.hotfixes, DEFAULT_SYSCOLLECTOR_HOTFIXES);
    assert_int_equal(limits.syscollector.packages, DEFAULT_SYSCOLLECTOR_PACKAGES);
    assert_int_equal(limits.syscollector.processes, DEFAULT_SYSCOLLECTOR_PROCESSES);
    assert_int_equal(limits.syscollector.ports, DEFAULT_SYSCOLLECTOR_PORTS);
    assert_int_equal(limits.syscollector.network_iface, DEFAULT_SYSCOLLECTOR_NETWORK_IFACE);
    assert_int_equal(limits.syscollector.network_protocol, DEFAULT_SYSCOLLECTOR_NETWORK_PROTO);
    assert_int_equal(limits.syscollector.network_address, DEFAULT_SYSCOLLECTOR_NETWORK_ADDR);
    assert_int_equal(limits.syscollector.hardware, DEFAULT_SYSCOLLECTOR_HARDWARE);
    assert_int_equal(limits.syscollector.os_info, DEFAULT_SYSCOLLECTOR_OS_INFO);
    assert_int_equal(limits.syscollector.users, DEFAULT_SYSCOLLECTOR_USERS);
    assert_int_equal(limits.syscollector.groups, DEFAULT_SYSCOLLECTOR_GROUPS);
    assert_int_equal(limits.syscollector.services, DEFAULT_SYSCOLLECTOR_SERVICES);
